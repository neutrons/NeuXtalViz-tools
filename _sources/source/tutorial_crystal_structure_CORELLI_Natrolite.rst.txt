...
3. Use the **Load CIF** button to select the Natrolite CIF used for CORELLI.
...
contains a scenario called ``CORELLI_Natrolite_Structure`` which:

- Activates the crystal-structure tool.
- Loads the Natrolite CIF from the tests data.
